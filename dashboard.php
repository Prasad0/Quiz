			...
			<div class="col-sm-12">
			  ...
			  <div class="container-fluid">
				<div class="navbar-header">
				  <a class="navbar-brand" href="dashboard.php?q=1">Online Mock Test</a>
				</div>
				...
				<ul class="nav navbar-nav navbar-right">
				  <li><a href="logout.php?q=home.php"><span class="glyphicon glyphicon-log-out"></span> Sign out</a></li>
...
<?php if(@$_GET['q']==0) {
echo "<div class='container col-md-offset-1 col-md-10'><div class='jumbotron'><h1>Successfully added Test</h1></div></div>";
}
?>
<!--ranking start-->
<?php
...
echo  '<div class="panel title jumbotron"><div class="table-responsive">
...
echo  '<div class="panel well"><div class="table-responsive"><table class="table table-striped title1">
